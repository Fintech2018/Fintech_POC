...
public class SentimentAnalysisHandlerTest {
    ...
    @Test
    public void testSentimentAnalysisHandler() {
        SentimentAnalysisHandler handler = new SentimentAnalysisHandler(s3Client);
